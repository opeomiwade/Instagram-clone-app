...
const Profile: React.FC<{ userData: { [key: string]: any } }> = ({
  ...
  function followButtonHandler() {
    if (!isCurrentUser) {
      ...
      isFollowing
        ? userData.followers.pop(currentUser.username)
            ...
            <header className="flex  justify-center p-6 gap-[100px]">
              ...
              <div className="flex flex-col justify-center gap-[25px]">
                ...
                <div className="flex justify-between ">
                  ...
                  <h3 className="font-bold hover:cursor-pointer">{`${userData.followers.length} followers`}</h3>
                  <h3 className="font-bold hover:cursor-pointer">{`${userData.following.length} following`}</h3>
                </div>
